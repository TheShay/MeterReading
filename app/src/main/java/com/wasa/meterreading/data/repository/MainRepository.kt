...
class MainRepository(private val apiHelper: ApiHelper) {
    ...
    suspend fun uploadReading(consumerCode: String, jsId: Int, reading: Int, remarks: String, image: String, lat: Double, long: Double) = apiHelper.uploadReading(consumerCode, jsId, reading, remarks, image, lat, long)
