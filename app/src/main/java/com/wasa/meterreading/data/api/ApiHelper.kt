...
class ApiHelper(private val apiService: ApiService) {
    ...
    suspend fun uploadReading(consumerCode: String, jsId: Int, reading: Int, remarks: String, lat: Double, long: Double) = apiService.uploadReading(consumerCode, jsId, reading, remarks, lat, long)
